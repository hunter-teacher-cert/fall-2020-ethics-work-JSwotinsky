...
# Software Solution in Progress

# To Do:
# row 5 seat 4
# Link passenger names to seats in a dict(?)
...
#TO DO: Check if seat is invalid
...
#Have to check if seat is already occupied
...
def askEconomy():
  ...
  displaySeats()  #delete after testing



#seats economy group
#for now treats all as adults
